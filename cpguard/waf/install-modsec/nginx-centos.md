...
Once the above steps are completed successfully, you can use the following parameter values from the cPGuard [Standalone configuration reference](../../standalone/configuration)
