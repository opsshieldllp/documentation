...
sidebar_label: ModSecurity with Nginx on CentOS/RockyLinux/AlmaLinux
sidebar_position: 3
---
...
Once the above steps are completed successfully, you can use the following parameter values in cPGuard [Standalone configuration file](../standalone/Modify-standalone-configuration.md)
