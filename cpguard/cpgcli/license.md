...
# How to Manage Your cPGuard License via CLI
...
:::note
If your server's **IP address changes** or you want to use an existing license on a different server, you must first **reissue the license** from the OPSSHIELD client area before applying it again. See the [Reissue License guide](../license/reissue-license.md) for details.
:::
...
Reissuing is done through the OPSSHIELD web portal. Refer to the [Reissue License guide](../license/reissue-license.md) for step-by-step instructions. Once reissued, apply it using the `--key` command above.
