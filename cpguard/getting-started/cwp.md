---
slug: cpguard-cwp-control-web-panel-security
title: Secure Your Control Web Panel (CWP) with cPGuard
sidebar_label: Install on Control Web Panel (CWP)
sidebar_position: 7
authors: [your-name]
...
# How to Secure Your Control Web Panel (CWP) Server with cPGuard
...
```
![Logo](../../assets/img/cpguard/standalone-panels/cpg_cwp_ngix_web.png)
...
Follow the dedicated guide: [Install ModSecurity with Nginx on CentOS / Rocky Linux / AlmaLinux](../waf/ModSecurity-Nginx-CentOS-RockyLinux-AlmaLinux.md)
:::
...
![Logo](../../assets/img/cpguard/standalone-panels/cpg_cwp_nginx_waf.png)
...
![Logo](../../assets/img/cpguard/standalone-panels/cpg_cwp_apache_web.png)
...
![Logo](../../assets/img/cpguard/standalone-panels/cpg_cwp_apache_waf.png)
