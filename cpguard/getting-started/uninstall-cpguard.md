---
slug: uninstall-cpguard
title: Uninstalling cPGuard
sidebar_position: 12
authors: [your-name]
tags: [cpguard, uninstall, opsshield, getting-started, faq, migration]
date: 2022-11-08
...
# How to Uninstall cPGuard from Your Server
...
:::tip
If you plan to reuse your cPGuard license on a different server or after an IP change, follow the [Migrate License to a New Server or IP Address](../license/migrate-license.md) guide before proceeding with uninstallation.
:::
...
- If you plan to reinstall cPGuard on this server in the future, simply run the [installation command](../getting-started/installation.md) again with your license key
...
You can also [grant the support team SSH access](../faq/grant-server-access-to-support.md) to your server so they can assist directly.
